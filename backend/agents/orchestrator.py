...
class Orchestrator:
    def __init__(self):
        ...
        # Import inside init to avoid circular imports
        ...
        print("✅ Orchestrator ready with Data Agent and Strategy Agent!")
    ...
    def route(self, question: str) -> str:
        ...
        # Comparison questions (coming soon)
    ...
    def _handle_comparison_question(self, question: str) -> str:
        """Handle comparison questions (coming soon)"""
        print(f"⚖️ [Comparison Agent] Coming soon: {question[:50]}...")
        # For now, fall back to Data Agent
        return self.data_agent.chat(question)